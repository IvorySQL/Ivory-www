    ...
    <div className="detail-sidebar">
      <div className="sidebar-sticky">
        ...
        <ul className="sidebar-nav">
          <li><Link to="#feature-chart">IvorySQL x Navicat 功能图</Link></li>
          <li><Link to="#certificate">官方兼容性认证证书</Link></li>
          <li><Link to="#about-ivorysql">关于 IvorySQL</Link></li>
          <li><Link to="#about-navicat">关于 Navicat</Link></li>
        </ul>
      </div>
    </div>
  </div>
