    ...
    <div className="detail-sidebar">
      <div className="sidebar-sticky">
        ...
        <ul className="sidebar-nav">
          <li><Link to="#pku-tradition">北京大学人才培养</Link></li>
          <li><Link to="#course-launch">通识课开展情况</Link></li>
          <li><Link to="#sharing">IvorySQL 技术分享</Link></li>
          <li><Link to="#future">培育未来研发人才</Link></li>
        </ul>
      </div>
    </div>
  </div>
