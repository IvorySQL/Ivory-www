...
export const DownloadPage = () => {
  ...
  const driverItems = [
    {
      ...
      platform: '全平台',
      size: '1.1 MB',
      // 替换为实际值: sha256sum postgresql-42.7.10.jar
      sha256: null,
  ...
  const toolItems = [
    {
      ...
      size: '—',
      // 替换为实际值: sha256sum assess-1.0.0-linux.gtk.x86_64.tar.gz
      sha256: null,
  ...
  const sectionMeta = {
    ...
    tools: { title: '支持工具', subtitle: '迁移与管理实用工具', accentColor: '#0891b2',
      ...
      <div style={{ background: 'linear-gradient(135deg, #7D52F4 0%, #5a35c4 60%, #4a28b0 100%)', borderRadius: '16px', padding: '40px 40px 36px', marginBottom: '40px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(125,82,244,0.18)', border: '1px solid rgba(125,82,244,0.35)', borderRadius: '20px', padding: '4px 14px', marginBottom: '16px' }}>
            ...
            <span style={{ fontSize: '0.8rem', color: '#c4b5fd', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase' }}>下载</span>
          </div>
