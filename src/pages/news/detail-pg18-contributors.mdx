  ...
  <div className="detail-sidebar">
    <div className="sidebar-sticky">
      ...
      <ul className="sidebar-nav">
        <li><a href="#interviews">Contributor Interviews</a></li>
        <li><a href="#li-chao">Li Chao's Advice</a></li>
        <li><a href="#niu-shiji">Niu Shiji's Tip</a></li>
        <li><a href="#li-yonghao">Li Yonghao's Story</a></li>
        <li><a href="#jiao-shuntian">Jiao Shuntian's Challenges</a></li>
        <li><a href="#han-weibo">Han Weibo's Strategy</a></li>
