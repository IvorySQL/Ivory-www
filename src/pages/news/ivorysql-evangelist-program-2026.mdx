  ...
  <div className="detail-main">
    ...
    <div className="post-content">
      ...
      <table>
        ...
        <tr><td rowspan="4"><strong>Contributions</strong></td><td>Submit feature request / improvement suggestion (approved)</td><td>5 / item</td></tr>
        <tr><td>Submit bug report (confirmed, with reproduction steps & environment info)</td><td>15 / item</td></tr>
