    ...
    <div className="detail-sidebar">
      <div className="sidebar-sticky">
        ...
        <ul className="sidebar-nav">
          <li><Link to="#feature-chart">Feature Chart</Link></li>
          <li><Link to="#certificate">Official Certificate</Link></li>
          <li><Link to="#about-ivorysql">About IvorySQL</Link></li>
          <li><Link to="#about-navicat">About Navicat</Link></li>
        </ul>
      </div>
    </div>
  </div>
