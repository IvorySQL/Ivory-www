  ...
  <div className="detail-sidebar">
    <div className="sidebar-sticky">
      ...
      <ul className="sidebar-nav">
        <li><a href="#pku-tradition">PKU Talent Cultivation</a></li>
        <li><a href="#course-launch">Course Launch Details</a></li>
        <li><a href="#sharing">IvorySQL Technology Sharing</a></li>
        <li><a href="#future">Nurturing Future Talent</a></li>
      </ul>
    </div>
  </div>
</div>