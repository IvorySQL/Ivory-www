  ...
  const driverItems = [
    {
      ...
      size: '1.1 MB',
      // Replace with: sha256sum postgresql-42.7.10.jar
      sha256: null,
            ...
            <div style={{ padding: '14px 16px' }}>
              {item.sha256 ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <span style={{ fontSize: '0.72rem', fontWeight: 700, color: accentColor, background: `${accentColor}12`, padding: '1px 6px', borderRadius: '3px', flexShrink: 0 }}>SHA256</span>
    ...
    <div style={{ maxWidth: '860px', margin: '0 auto', paddingBottom: '48px' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #7D52F4 0%, #5a35c4 60%, #4a28b0 100%)', borderRadius: '16px', padding: '40px 40px 36px', marginBottom: '40px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(125,82,244,0.18)', border: '1px solid rgba(125,82,244,0.35)', borderRadius: '20px', padding: '4px 14px', marginBottom: '16px' }}>
            <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#c4b5fd' }} />
            <span style={{ fontSize: '0.8rem', color: '#c4b5fd', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Downloads</span>
          </div>
